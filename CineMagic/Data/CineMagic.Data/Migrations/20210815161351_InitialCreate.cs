        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Biography = table.Column<string>(type: "nvarchar(max)", maxLength: 20000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Popularity = table.Column<double>(type: "float", nullable: false),
                    CurrentAverageVote = table.Column<double>(type: "float", nullable: false),
                    CurrentNumberOfVotes = table.Column<int>(type: "int", nullable: false),
                    DirectorId = table.Column<int>(type: "int", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuthorsReviews", x => new { x.AuthorId, x.ReviewId });
                    table.ForeignKey(
                        name: "FK_AuthorsReviews_Authors_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "Authors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AuthorsReviews_Reviews_ReviewId",
                        column: x => x.ReviewId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MovieId = table.Column<int>(type: "int", nullable: false),
                    ActorId = table.Column<int>(type: "int", nullable: false),
                    CharacterName = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedOn = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuthorsReviews_IsDeleted",
                table: "AuthorsReviews",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_AuthorsReviews_ReviewId",
                table: "AuthorsReviews",
                column: "ReviewId");
