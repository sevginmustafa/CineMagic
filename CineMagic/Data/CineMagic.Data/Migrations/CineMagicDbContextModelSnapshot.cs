...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CineMagic.Data.Models.AdminContactFormEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CineMagic.Data.Models.Author", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CineMagic.Data.Models.AuthorReview", b =>
                {
                    ...
                    b.ToTable("AuthorsReviews");
                });

            modelBuilder.Entity("CineMagic.Data.Models.ContactFormEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CineMagic.Data.Models.Language", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CineMagic.Data.Models.MovieLanguage", b =>
                {
                    b.Property<int>("MovieId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CineMagic.Data.Models.MovieReview", b =>
                {
                    b.Property<int>("MovieId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CineMagic.Data.Models.AuthorReview", b =>
                {
                    b.HasOne("CineMagic.Data.Models.Author", "Author")
                        .WithMany("Reviews")
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("CineMagic.Data.Models.Review", "Review")
                        .WithMany("Authors")
            ...
            modelBuilder.Entity("CineMagic.Data.Models.MovieLanguage", b =>
                {
                    b.HasOne("CineMagic.Data.Models.Language", "Language")
                        .WithMany("Movies")
