namespace InTheAction.Web
{
    ...
    public class Startup
    {
        ...
        {
            services.AddDbContext<InTheActionDbContext>(
                options => options.UseSqlServer(this.configuration.GetConnectionString("DefaultConnection")));

            services.AddDefaultIdentity<ApplicationUser>(IdentityOptionsProvider.GetIdentityOptions)
                .AddRoles<ApplicationRole>().AddEntityFrameworkStores<InTheActionDbContext>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                var dbContext = serviceScope.ServiceProvider.GetRequiredService<InTheActionDbContext>();
